...
class VimCommands:
    ...
    def init_state_ivars(self) -> None:
        ...
        self.command_w: StringTextWrapper = None  # The widget in effect at the start of a command.
        ...
        self.vis_mode_w: StringTextWrapper = None
    ...
    def begin_insert_mode(self, i: int = None, w: StringTextWrapper = None) -> None:
    ...
    def test_for_insert_escape(self, w: StringTextWrapper) -> bool:
    ...
    def is_body(self, w: StringTextWrapper) -> bool:
        """Return True if w is the QTextBrowser of the body pane."""
        g.checkTextWidget(w)
        w2 = self.c.frame.body.wrapper
        return w == w2

    def is_head(self, w: StringTextWrapper) -> bool:
    ...
    def is_text_wrapper(self, w: StringTextWrapper = None) -> bool:
    ...
    def set_border(
        self, kind: str = None, w: StringTextWrapper = None, activeFlag: bool = None
    ) -> None:
        """
    ...
    def set_property(self, w: StringTextWrapper, focus_flag: bool) -> None:
    ...
    def widget_name(self, w: StringTextWrapper) -> str:
        g.checkTextWidget(w)
